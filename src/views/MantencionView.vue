...
<template>
  ...
  <v-card max-width="800" flat class="mx-auto my-10">
    <v-btn class="ml-2 mb-6" icon :to="{name: 'cliente', params:{id: route.params.idCliente}}"><v-icon size="30">mdi-arrow-left</v-icon></v-btn>
    ...
    <v-form class="mt-10">
      ...
      <v-row v-if="aceite.value.value">       
        <v-col  cols="12" md="6" >
          <v-select :disabled="disableEdit" label="Cambio de aceite cada:  (km)"  :items="cadaCuantosKm" v-model="cambioAceite.value.value"    
          ></v-select>
        </v-col>
    ...
    <v-row v-if="revisiones.value.value">
      ...
      <v-col cols="12" md="4" >
          <v-checkbox :disabled="disableEdit" label="Inspección visual de motor" v-model="inspeccionVisualMotor.value.value" />
      </v-col>
      <v-col cols="12" md="4" >
